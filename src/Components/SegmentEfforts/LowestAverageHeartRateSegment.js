...
export default function LowestAverageHeartRateSegment({
  lastFmUserData,
  segmentEfforts,
}) {
  ...
  return (
    <>
      <div className="container segment-effort-div pt-2 mt-2">
        <h5>
          Your average heart rate was lowest in this segment:{" "}
          {segmentEffort.name}
        </h5>
        <div className="row">
